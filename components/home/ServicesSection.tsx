    ...
    <section id="services" className="pt-24 md:pt-[100px]">
      ...
      <div className="flex flex-col gap-0">
        {services.map((s) => (
          ...
          >
            <div className="relative overflow-hidden rounded-[20px] px-4 py-6 transition group-hover:bg-white/5 sm:px-5 sm:py-8 md:px-6">
              <div className="relative z-[1] flex items-start justify-between gap-3 sm:items-center sm:gap-4">
                <div className="flex min-w-0 items-start gap-3 sm:items-center sm:gap-6">
                  <span className="shrink-0 pt-0.5 text-[11px] font-medium text-zen-muted sm:pt-0 sm:text-[12px]">
                    {s.n}/
                  </span>
                  <h5 className="min-w-0 font-display text-base leading-snug text-zen-text sm:text-lg md:text-2xl">
